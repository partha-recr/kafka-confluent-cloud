...
public class DataRecordAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7370329885577634302L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DataRecordAvro\",\"namespace\":\"com.example.kafkademo.schema\",\"fields\":[{\"name\":\"count\",\"type\":\"long\"}]}");
   ...
   */
  public static com.example.kafkademo.schema.DataRecordAvro.Builder newBuilder() {
    return new com.example.kafkademo.schema.DataRecordAvro.Builder();
  }
   ...
   * @return A new DataRecordAvro RecordBuilder
   */
  public static com.example.kafkademo.schema.DataRecordAvro.Builder newBuilder(com.example.kafkademo.schema.DataRecordAvro.Builder other) {
    if (other == null) {
      return new com.example.kafkademo.schema.DataRecordAvro.Builder();
    } else {
      return new com.example.kafkademo.schema.DataRecordAvro.Builder(other);
    }
  }
   ...
   * @return A new DataRecordAvro RecordBuilder
   */
  public static com.example.kafkademo.schema.DataRecordAvro.Builder newBuilder(com.example.kafkademo.schema.DataRecordAvro other) {
    if (other == null) {
      return new com.example.kafkademo.schema.DataRecordAvro.Builder();
    } else {
      return new com.example.kafkademo.schema.DataRecordAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DataRecordAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafkademo.schema.DataRecordAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafkademo.schema.DataRecordAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.count)) {
        this.count = data().deepCopy(fields()[0].schema(), other.count);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkademo.schema.DataRecordAvro.Builder setCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkademo.schema.DataRecordAvro.Builder clearCount() {
